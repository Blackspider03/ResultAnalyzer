...
public class studentprogressAdpter extends RecyclerView.Adapter<studentprogressAdpter.ImageViewHolder> {
    private final Context mContext;
    private final List<basicstud> mUploads;
    private static OnItemClickListener mlistner;

    public studentprogressAdpter(Context context, List<basicstud> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext,studentprogressstep2.class);
