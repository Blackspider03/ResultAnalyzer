...
public class viewstudentprofile extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewstudentprofile);
        sp1 = findViewById(R.id.spinner3);
        textView = findViewById(R.id.textView7);
        mRecyclerView = findViewById(R.id.recycle1);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        sp1.setOnItemSelectedListener(viewstudentprofile.this);
    ...
    private void fetchstudent(String department) {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapter = new ImageAdpter(viewstudentprofile.this, mUploads);
