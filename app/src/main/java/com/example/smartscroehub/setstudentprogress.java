...
public class setstudentprogress extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    studentprogressAdpter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setstudentprogress);

        sp1 = findViewById(R.id.spinner51);
        textView = findViewById(R.id.textView126);
        mRecyclerView = findViewById(R.id.recycle143);
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        sp1.setOnItemSelectedListener(setstudentprogress.this);
    ...
    private void fetchstudent(String department) {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mAdapter = new studentprogressAdpter(setstudentprogress.this, mUploads);
