...
public class ImageAdpter extends RecyclerView.Adapter<ImageAdpter.ImageViewHolder> {
    ...
    public ImageAdpter(Context context, List<basicstud> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext,detailedstudentprofile.class);

                intent.putExtra("m1",studname);
                intent.putExtra("m2",prn1);
                intent.putExtra("m3",email);
                intent.putExtra("m4",mobile);
                intent.putExtra("m5",branch);
                intent.putExtra("m6",year);
